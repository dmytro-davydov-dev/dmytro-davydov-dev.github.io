...
export const PORTFOLIO_PROJECTS = [
  {
    ...
    description: [
      'AI Video Management Platform is an architecture-first reference implementation for building secure, observable, event-driven computer-vision systems, deliberately scoped to management and analytical workflows: training simulation, logistics optimization, infrastructure inspection, search-and-rescue, and situational-awareness monitoring.',
